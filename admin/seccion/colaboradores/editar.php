    ...
    <div class="card-body">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <img width="100" src="../../../images/colaboradores/<?php echo $foto;?>" alt="">
            ...
            <div class="mb-3">
                ...
                <input type="text" value="<?php echo $linkfacebook;?>" class="form-control" name="linkfacebook" id="linkfacebook"
                    aria-describedby="helpId" placeholder="Link Facebook">
            </div>

            <div class="mb-3">
                <label for="" class="form-label">Instagram:</label>
                <input type="text" value="<?php echo $linkinstagram;?>" class="form-control" name="linkinstagram" id="linkinstagram"
            ...
            <div class="mb-3">
                ...
                <input type="text" value="<?php echo $linklinkedin;?>" class="form-control" name="linklinkedin" id="linklinkedin"
