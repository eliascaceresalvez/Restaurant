...
<div class="card">
    ...
    <a name="" id="" class="btn btn-primary" href="crear.php" role="button"><i class="bi bi-plus-circle"></i> Agregar comida</a>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td>
                            <img src="../../../images/menu/<?php echo $registro['foto'] ?>" width="100" alt="">
                        </td>
